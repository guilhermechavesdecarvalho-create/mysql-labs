...
CREATE TABLE `autorlivro` (
  `id_autorLivro` int NOT NULL AUTO_INCREMENT,
  `id_livro` int NOT NULL,
  `id_autor` int NOT NULL,
  PRIMARY KEY (`id_autorLivro`),
  KEY `id_livro` (`id_livro`),
  KEY `id_autor` (`id_autor`),
  CONSTRAINT `autorlivro_ibfk_1` FOREIGN KEY (`id_livro`) REFERENCES `livro` (`id_livro`),
  CONSTRAINT `autorlivro_ibfk_2` FOREIGN KEY (`id_autor`) REFERENCES `autor` (`id_autor`)
...
-- Dump completed on 2026-08-06 21:57:02
