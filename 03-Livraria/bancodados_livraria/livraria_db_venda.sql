...
CREATE TABLE `venda` (
  ...
  CONSTRAINT `venda_ibfk_1` FOREIGN KEY (`id_itemVenda`) REFERENCES `itemvenda` (`id_itemVenda`),
  CONSTRAINT `venda_ibfk_2` FOREIGN KEY (`id_livro`) REFERENCES `livro` (`id_livro`)
